...
static void synth_ccall_pushThreeArgs ( Int r1, Int r2, Int r3 )
{
   /* must push in reverse order */
   emit_pushv_reg ( 4, r3 );
   emit_pushv_reg ( 4, r2 );
	 ...
	 */
	 ...
	 vg_assert(!VG_(anyFlagUse)(u));
      ...
      case CCALL_3_0:
         ...
         synth_ccall_saveRegs();
         synth_ccall_pushThreeArgs ( u->val1, u->val2, u->val3 );
         synth_ccall_call_clearStack_restoreRegs ( u->lit32, 12 );
         break;
