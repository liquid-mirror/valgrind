...
#if defined(VGP_ppc64_linux) && !defined(VGPV_ppc64_linux_bgq)
...
// _____(__NR_waitid,            sys_waitid),             // 272
   ...
   LINXY(__NR_get_robust_list,   sys_get_robust_list),    // 299
...
#endif // defined(VGP_ppc64_linux) && !defined(VGPV_ppc64_linux_bgq)
