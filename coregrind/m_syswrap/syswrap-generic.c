                                   ...
                                   const Char *syscallname)
{
   ...
   if (0)
      VG_(printf)("%s: test=%08lx-%08lx ret=%d\n",
...
PRE(sys_mremap)
{
   ...
   if (ARG4 & VKI_MREMAP_FIXED) {
      PRINT("sys_mremap ( %#lx, %llu, %ld, %#lx, %#lx )", 
...
PRE(sys_mknod)
{
   PRINT("sys_mknod ( %#lx(%s), %#lx, %#lx )", ARG1, (Char*)ARG1, ARG2, ARG3 );
...
{
   *flags |= SfMayBlock;
   PRINT("sys_init_module ( %#lx, %llu, %#lx )", ARG1, (ULong)ARG2, ARG3 );
...
PRE(sys_execve)
{
  ...
  hosed:
   vg_assert(FAILURE);
   VG_(message)(Vg_UserMsg, "execve(%p(%s), %p, %p) failed, errno %ld",
...
PRE(sys_chown)
{
   PRINT("sys_chown ( %#lx(%s), %#lx, %#lx )", ARG1,(Char*)ARG1,ARG2,ARG3);
...
PRE(sys_lchown)
{
   PRINT("sys_lchown ( %#lx(%s), %#lx, %#lx )", ARG1,(Char*)ARG1,ARG2,ARG3);
...
PRE(sys_setreuid)
{
   PRINT("sys_setreuid ( %#lx, %#lx )", ARG1, ARG2);
...
PRE(sys_newstat)
{
   PRINT("sys_newstat ( %#lx(%s), %#lx )", ARG1, (const char*)ARG1,ARG2);
...
PRE(sys_statfs)
{
   PRINT("sys_statfs ( %#lx(%s), %#lx )",ARG1,(const char*)ARG1,ARG2);
...
PRE(sys_statfs64)
{
   PRINT("sys_statfs64 ( %#lx(%s), %llu, %#lx )",ARG1,(const char*)ARG1,(ULong)ARG2,ARG3);
