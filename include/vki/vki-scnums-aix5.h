...
#define __NR_AIX5_ptx_get_dkstats_pathname VG_(aix5_NR_ptx_get_dkstats_pathname)
...
#define __NR_AIX5_ptx_get_num_intr_source VG_(aix5_NR_ptx_get_num_intr_source)
...
#define __NR_AIX5_ptx_get_numkmembuckets VG_(aix5_NR_ptx_get_numkmembuckets)
...
#define __NR_AIX5_ptx_get_dkstats_diskname VG_(aix5_NR_ptx_get_dkstats_diskname)
